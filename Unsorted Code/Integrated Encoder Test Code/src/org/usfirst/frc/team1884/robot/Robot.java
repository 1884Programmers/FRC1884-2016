...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		if (Math.abs(frontRight.getEncVelocity()) > 23200) {
			System.out.println("GO "+frontRight.getEncVelocity());
		}else{
			System.out.println(frontRight.getEncVelocity());
		}
